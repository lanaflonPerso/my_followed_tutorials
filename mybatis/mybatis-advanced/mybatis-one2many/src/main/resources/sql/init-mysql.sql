...
(
    ...
    CONSTRAINT FK_STUDENTS_ADDR FOREIGN KEY (addr_id) REFERENCES address (addr_id)
)
    ENGINE = InnoDB
    DEFAULT CHARSET = utf8;
...
(
    ...
    UNIQUE KEY UK_EMAIL (email),
    CONSTRAINT FK_TUTORS_ADDR FOREIGN KEY (addr_id) REFERENCES address (addr_id)
)
    ENGINE = InnoDB
    DEFAULT CHARSET = utf8;
...
INSERT INTO tutor (tutor_id, name, email, phone, dob, gender, bio, pic, addr_id) VALUES
