...
import com.wefine.reactive.entity.*;
        ...
        final Mono<Void> initializeCollections =
                mongoTemplate
                        ...
                        .then(mongoTemplate.createCollection(
                                MatchEvent.class, CollectionOptions.empty().maxDocuments(104857600L))) // max: 100MBytes
                        .then(mongoTemplate.createCollection(
                                MatchComment.class, CollectionOptions.empty().maxDocuments(104857600L))) // max: 100MBytes
                        .then();
